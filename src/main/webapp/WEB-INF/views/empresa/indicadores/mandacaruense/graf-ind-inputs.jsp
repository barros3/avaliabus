...
<script type="text/javascript">
	...
	function drawChartFre() {
		$
				.ajax({
					type : "post",
					url : "/avaliabus/empresa/indicadores/graf-indicadores-empresa-mandacaruense",
...
<h1 class="mdl-color-text--primary mdl-shadow--6dp"
		style="text-align: center; height: 8%; margin: 0% 0% 0% 0%; padding-top: 1%; width: 100%; background-color: gold;">Indicadores Gerais da Mandacaruense</h1>
<br>
<p style="font-size: 22px; text-align: justify !important; font-family: serif; margin: 5% 10% 3% 11%;">
			Nesta área você tem acesso aos indicadores completo da empresa de transporte coletivo MANDACARUENSE. 
	</p>
