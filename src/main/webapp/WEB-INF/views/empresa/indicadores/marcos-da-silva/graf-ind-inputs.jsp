					...
					success : function(response) {
						...
						var data = google.visualization
								.arrayToDataTable([
										...
										[ "Bom", response["limpeza"].limpezaBom ],
										[
												"Excelente",
					...
					success : function(response) {
						...
						var data = google.visualization
								.arrayToDataTable([
										...
										[ "Bom", response["lotacao"].lotacaoBom ],
										[
												"Excelente",
...
<div class="android-more-section mdl-dialog full-width"
	...
	<h1 class="mdl-color-text--primary mdl-shadow--6dp"
		style="text-align: center; height: 8%; margin: 0% 0% 0% 0%; padding-top: 1%; width: 100%; background-color: gold;">Indicadores
		Gerais da MARCOS DA SILVA</h1>
	<br>
	<p
		style="font-size: 22px; text-align: justify !important; font-family: serif; margin: 5% 10% 3% 11%;">
		Nesta área você tem acesso aos indicadores completo da empresa de
		transporte coletivo MARCOS DA SILVA.
	...
	<div class="mdl-cell--4-col" style="margin: 2% 0% -6% 90%">
		<a class="mdl-button mdl-button--fab mdl-button--primary"
			style="text-decoration: none"
			href="<c:url value='/resultados/form' />"> < </a>
	</div>
</div>