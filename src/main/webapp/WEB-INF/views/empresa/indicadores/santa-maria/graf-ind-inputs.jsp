...
<script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChartSantMaFre);
      google.charts.setOnLoadCallback(drawChartSantMaLimp);
      google.charts.setOnLoadCallback(drawChartSantMaLot);
      
      google.charts.setOnLoadCallback(drawChartSantMaCoduMoto);
      google.charts.setOnLoadCallback(drawChartSantMaConser);
      google.charts.setOnLoadCallback(drawChartSantMaPont);
      
      
	function drawChartSantMaFre() {
		$
				.ajax({
					type : "post",
	...
	function drawChartSantMaCoduMoto() {
		$
				.ajax({
					type : "post",
					url : "empresa/indicadores/graf-indicadores-empresa-santa-maria",
	...
	function drawChartSantMaConser() {
		$
				.ajax({
					type : "post",
					url : "empresa/indicadores/graf-indicadores-empresa-santa-maria",
...
<h1 class="mdl-color-text--primary mdl-shadow--6dp"
		style="text-align: center; height: 8%; margin: 0% 0% 0% 0%; padding-top: 1%; width: 100%; background-color: gold;">Indicadores Gerais da Santa Maria</h1>
<br>
<p style="font-size: 22px; text-align: justify !important; font-family: serif; margin: 5% 10% 3% 11%;">
			Nesta área você tem acesso aos indicadores completo da empresa de transporte coletivo SANTA MARIA. 
	</p>
